        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-foreground/80">hello@johndoe.com</p>
                </div>
              </div>
            ...
            <div className="mt-12">
              ...
              <div className="flex gap-4">
                <a
                  href="#"
                  className="p-3 rounded-full bg-background border border-border hover:bg-primary/10 hover:text-primary transition-colors"
                  aria-label="Twitter"
                >
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                className="w-full sm:w-auto gap-2 bg-gradient-to-r from-teal-500 to-violet-500 hover:from-teal-600 hover:to-violet-600"
